"""
Nostalgia Classifier - DistilBERT Fine-tuning
Detects nostalgic framing in political advertisements.

Usage:
    python train.py --data_path full_450_ads_realistic.csv --epochs 5
...
def main(args):
    ...
    print(f"Cohen's κ: {test_metrics['cohen_kappa']:.4f}")
    ...
    print(f"\nBaseline comparison:")
    print(f"  Dictionary method: 94% agreement, κ = 0.87")
    print(f"  DistilBERT:        {test_metrics['accuracy']*100:.1f}% accuracy, κ = {test_metrics['cohen_kappa']:.2f}")
